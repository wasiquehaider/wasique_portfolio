      ...
      >
        <div className="p-4 md:p-12 text-center lg:text-left">
          <div
            ...
            style={{
              backgroundImage: `url(${urlFor(author.authorImage).url()})`,
            }}
          ></div>

          <h1 className="text-3xl font-bold pt-8 lg:pt-0">{`Hi there! I am ${author.name}`}</h1>
          ...
          <div className="prose lg:prose-xl my-10 text-blue">
            <BlockContent
              blocks={author.bio}
              projectId="90nsrcjp"
              dataset="production"
